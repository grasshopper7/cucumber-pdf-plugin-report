...
Feature: Scenario And Scenario Outline
  ...
  @scen
  Scenario: Scenario Number Eight Eight Eight
    Scenario Description

    Given Write a 'given' step with precondition in 'Scenario 888'
    When Complete action in 'when' step in 'Scenario 888'
    Then Validate the outcome in 'then' step in 'Scenario 888'
